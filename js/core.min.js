  ...
  (function (k, p, q) {
    return (function () {
      ...
      h.prototype.Defaults = {
        ...
        localTemplate: {
          message:
            "This is sample tweet for local testing. Upload your project to the live hosting server for get data from twitter.com",
          serverMessage:
            "RD Twitter Feed: Please upload project to the server for enable plugin!",
          user_name: "TemplateMonster",
          date: "Fri Nov 06 11:20:43 +0000 2015",
          tweet:
            "Check Out NEW #Photographer Portfolio Responsive Photo - goo.gl/ECjPvq",
          avatar:
            "http://pbs.twimg.com/profile_images/611164752396419072/hJYLqLJR_normal.jpg",
          url: "",
          screen_name: "",
          media_url: [
            "https://pbs.twimg.com/media/CS6HxzwUEAALx0y.jpg",
            "http://pbs.twimg.com/media/CShUCIYUcAABb53.jpg",
          ],
        },
        dateText: {
          seconds: "less 1m",
      ...
      h.prototype.initialize = function () {
        ...
        if (this.isLocal())
          a.prepend("<h6>" + this.options.localTemplate.message + "</h6>");
        else if (!this.isServer()) {
          a.prepend(
            "<h6>" + this.options.localTemplate.serverMessage + "</h6>",
          );
          return;
        }
        a.append(
          '<span id="loading_tweet">' +
            (a.attr("data-twitter-loading")
              ? a.attr("data-twitter-loading")
      ...
      h.prototype.dating = function (a, c) {
        ...
        var b = a.split(" ");
        a = new Date(
          Date.parse(b[1] + " " + b[2] + ", " + b[5] + " " + b[3] + " UTC"),
        );
        var e = (new Date().getTime() - a.getTime()) / 1e3;
        b =
          "January February March April May June March August September October November December".split(
            " ",
          );
        b = {
          "%d": a.getDate(),
        ...
        var g = c
          ? "%Y-%m-%d"
          : this.$element.attr("data-twitter-date-format")
            ? this.$element.attr("data-twitter-date-format")
            : this.options.dateFormat;
        if (60 > e)
          return this.$element.attr("data-twitter-date-seconds")
            ? this.$element.attr("data-twitter-date-seconds")
            : this.options.dateText.seconds;
        if (60 > e / 60)
          return (
            Math.round(e / 60) +
            (this.$element.attr("data-twitter-date-minutes")
              ? this.$element.attr("data-twitter-date-minutes")
              : this.options.dateText.minutes)
          );
        if (24 > e / 60 / 60)
          return (
            Math.round(e / 60 / 60) +
            (this.$element.attr("data-twitter-date-hours")
              ? this.$element.attr("data-twitter-date-hours")
              : this.options.dateText.hours)
          );
        if (2 > e / 60 / 60 / 24)
          return this.$element.attr("data-twitter-date-yesterday")
            ? this.$element.attr("data-twitter-date-yesterday")
            : this.options.dateText.yesterday;
      ...
      h.prototype.isLocal = function () {
        ...
        for (a = c.length; d < a; d++) {
          var b = c[d];
          if (-1 < p.location.hostname.indexOf(b)) return !0;
        }
        return !1;
      };
      ...
      h.prototype.getMedia = function (a) {
        ...
        if (a.extended_entities) {
          if (a.extended_entities.media) {
            var d = [];
            var b = a.extended_entities.media;
            var e = 0;
            for (c = b.length; e < c; e++) ((a = b[e]), d.push(a.media_url));
            return d;
          }
        } else
          return a.entities && a.entities.media
        ...
        k.getJSON(
          this.options.apiPath,
          {
            username: a.attr("data-twitter-username")
              ? a.attr("data-twitter-username")
              : this.options.username,
            list: a.attr("data-twitter-listname")
              ? a.attr("data-twitter-listname")
              : this.options.list,
            hashtag: a.attr("data-twitter-hashtag")
              ? a.attr("data-twitter-hashtag")
              : this.options.hashtag,
      ...
      h.prototype.parseAttributes = function (a, c, d) {
        ...
        for (b in f)
          if (
            (f[b] || ("xImage" !== f[b] && "xId" !== f[b])) &&
            f.hasOwnProperty(b) &&
            "string" === typeof f[b]
          ) {
            var h = f[b].split(/\s?,\s?/i);
            var m = 0;
            for (e = h.length; m < e; m++) {
              ...
              "data-x-id" !== l &&
                ...
                ("text" === l.toLowerCase()
                  ? (a.innerHTML = c[b])
                  : "media_url" === b
                    ? k.isArray(c[b]) && c[b].length > d
                      ? a.setAttribute(l, c[b][d])
                      : null !== c[b] && 0 === d
                        ? a.setAttribute(l, c[b])
                        : g.remove()
                    : a.setAttribute(l, c[b]));
            }
          }
      ...
      k.fn.extend({
        RDTwitter: function (a) {
          this.each(function () {});
          var c = k(this);
          if (!c.data("RDTwitter")) return c.data("RDTwitter", new h(this, a));
        },
      });
      return h;
    })();
 ...
 */
function Toggle(t) {
  if (!t.node) throw new Error("Toggle node is required");
  if (!t.targets) throw new Error("Target node is required");
  ((this.node = t.node),
    (this.node.mt = this),
    (this.state = t.state || !1),
    (this.clas = t.clas || "active"),
    (this.targets = t.targets),
    (this.scope = t.scope || null),
    (this.isolate = t.isolate || null));
  for (var e = 0; e < this.targets.length; e++)
    this.targets[e].mtt
      ? this.targets[e].mtt.toggles.push(this.node)
      : new Target({
          node: this.targets[e],
          toggles: [this.node],
          state: this.state,
  ...
  if (
    ...
    this.node.addEventListener("changeState", function (t) {
      t.emitter.mtt.state !== this.mt.state && this.mt.changeState();
    }),
    this.scope.length)
  ) {
    var s = this;
    document.addEventListener("click", function (t) {
      !s.checkScope(t.target) && s.state && s.changeState();
    });
  }
  if (this.isolate.length) {
    s = this;
    document.addEventListener("click", function (t) {
      s.checkIsolate(t.target) && s.state && s.changeState();
    });
  }
  return this;
}
function Target(t) {
  return (
    ...
    (this.state = t.state || !1),
    (this.clas = t.clas || "active"),
    (this.toggles = t.toggles),
    this.node.addEventListener("changeState", function (t) {
      t.emitter.mt.state !== this.mtt.state && this.mtt.changeState();
    }),
    this
  );
}
((Toggle.prototype.changeState = function (t) {
  ((this.state = !this.state), this.node.classList.toggle(this.clas));
  for (var e = 0; e < this.targets.length; e++) {
    var s = new CustomEvent("changeState");
    ((s.emitter = this.node), this.targets[e].dispatchEvent(s));
  }
}),
  (Toggle.prototype.checkScope = function (t) {
    if (this.node.contains(t)) return !0;
    for (var e = 0; e < this.scope.length; e++)
      if (this.scope[e].contains(t)) return !0;
    return !1;
  }),
  (Toggle.prototype.checkIsolate = function (t) {
    if (this.node.contains(t)) return !1;
    for (var e = 0; e < this.isolate.length; e++)
      if (this.isolate[e].contains(t)) return !0;
    return !1;
  }),
  (Target.prototype.changeState = function () {
    ((this.state = !this.state), this.node.classList.toggle(this.clas));
    for (var t = 0; t < this.toggles.length; t++) {
      var e = new CustomEvent("changeState");
      ((e.emitter = this.node), this.toggles[t].dispatchEvent(e));
    }
  }));
